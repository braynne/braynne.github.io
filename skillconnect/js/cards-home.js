...
function cargarUsuarios() {
                ...
                .then(usuarios => {
                    ...
                    usuarios.forEach(usuario => {
                        ...
                        if (usuario.role === "worker") {
                            ...
                            col.classList.add("col-xxl-4", "col-xl-4", "col-lg-4", "col-md-6", "col-sm-12", "mb-3", "container-fluid");
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <a href="profile-other.html?username=${usuario.username}" class="btn btn-primary form-control">Ir a perfil</a>
        </div>
    </div>
`;
